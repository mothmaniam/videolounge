...
{
    public partial class ViewDebtUnpaidReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=" + "DebtUnpaid" + "-" + Session["CompanyName"].ToString());
