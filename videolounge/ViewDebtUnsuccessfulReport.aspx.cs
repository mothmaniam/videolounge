...
{
    public partial class ViewDebtUnsuccessfulReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=" + "Unsuccessful" + "-" + Session["CompanyName"].ToString());
