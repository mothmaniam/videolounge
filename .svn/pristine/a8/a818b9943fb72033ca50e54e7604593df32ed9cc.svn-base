...
{
    public partial class ViewDebtCompletedReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=" + "DebtCompleted" + "-" + Session["CompanyName"].ToString());
