...
{
    public partial class sortByRegion : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=" + "JobsByRegion-" + DateTime.Now.ToShortDateString());
