...
{
    public partial class sortByIndustry : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=" + "JobsByIndustry-" + DateTime.Now.ToShortDateString());
