...
{
    public partial class ViewQuotesReport : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=" + "Quotes" + "-" + Session["CompanyName"].ToString());
