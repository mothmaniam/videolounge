<%@ Page Title="Marketing Actions - Debbie" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="MADebbie.aspx.cs" Inherits="videolounge.MADebbie" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
     <table style="margin-left:250px">
        <tr>
            <td>
                <asp:Label ID="lblMADebbie" runat="server" Text="Marketing Actions - Debbie" ForeColor="#4D6095" Font-Bold="true"></asp:Label>
            </td>
            <td>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <table>
        ...
        <tr>
            <td>
                <asp:Label ID="lblMoveToPipeline" runat="server" Text="Move to Pipeline?" CssClass="fancyLabel2"></asp:Label>
            </td>
            <td>
                <asp:RadioButton ID="radioPipelineYes" runat="server" Text="Yes" CssClass="fancyLabel" AutoPostBack="true" GroupName="pipeline"/>&nbsp;
                <asp:RadioButton ID="radioPipelineNo" runat="server" Text="No" CssClass="fancyLabel" AutoPostBack="true" GroupName="pipeline"/>
            </td>
        </tr>
        <tr>
            <td>
