<%@ Page Title="Marketing Actions - Graeme" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="MAGraeme.aspx.cs" Inherits="videolounge.MAGraeme" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <table style="margin-left:250px">
        <tr>
            <td>
                <asp:Label ID="lblMAGraeme" runat="server" Text="Marketing Actions - Graeme" ForeColor="#4D6095" Font-Bold="true"></asp:Label>
            </td>
            <td>
...
<div style="float:left; width:20px">
    <asp:ListBox ID="lstOpportunities" runat="server" AutoPostBack="True" CssClass="compactListbox2"
        Height="260px" ToolTip="Select opportunity number from list box to load the details" OnSelectedIndexChanged="lstOpportunities_SelectedIndexChanged"></asp:ListBox>
</div>
    <table>
        <tr>
            <td>
            ...
            <td>
                <asp:Label ID="lblEntity" runat="server" Text="Entity/Company" 
                    CssClass="fancyLabel"></asp:Label>
            </td>
            <td>
    ...
    <table>
        ...
        <tr>
            <td colspan="2"></td>
            <td>
                <asp:Button ID="btnUpdate" runat="server" Text="Update" CssClass="silverButton" 
                    ToolTip="Click here to update this marketing action" onclick="btnUpdate_Click"/>
            </td>
        </tr>
    </table>
</asp:Content>
